...
// Invoke a job in Folder
// First parameter job name, second parameter is optional Build parameters and the last parameter is folder name.
// Returns queue id
func (j *Jenkins) BuildJobInFolder(ctx context.Context, name string, params map[string]string, parentIDs ...string) (int64, error) {
